...
public class SimpleTest {
	...
	public void MethodShouldHandleWhenNumThreadsIsLargerThanArraySize() {
		...
		assertTrue("Result is " + frequency + ", expected frequency of 3 is 2.", frequency == 2);
	}
	...
	public void MethodShouldReturnZeroWhenArrayIsNullOrEmpty() {
		...
		assertTrue("Result is " + frequency + ", expected frequency of 3 is 0.", frequency == 0);

		int[] nullArray = null;
		frequency = Frequency.parallelFreq(3, null, 8);
		assertTrue("Result is " + frequency + ", expected frequency of 3 is 0.", frequency == 0);
	}
}